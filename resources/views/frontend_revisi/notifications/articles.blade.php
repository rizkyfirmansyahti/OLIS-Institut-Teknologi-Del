        ...
        <div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm"
            ...
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    <h1>ARTIKEL BARU</h1>
                    <h5 class="text-white">Sejak : {{ $lastUpdated->updated_at->format('d F Y') }}</h5>
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/"> Beranda</a></li>
                            <li class="breadcrumb-item">Artikel Baru</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <aside class="side-bar sticky-top mt-lg-0 mt-md-5 mb-4">
                            <select class="form-select border rounded" placeholder="Filter Artikel">
                                <option selected>Filter Artikel</option>
