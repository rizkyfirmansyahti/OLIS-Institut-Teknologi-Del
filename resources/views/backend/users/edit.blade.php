...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('backend.users.update', encodeId($user->id)) }}" method="post">
                        @csrf
                        @method('put')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('id_member') is-invalid @enderror"
                                            ...
                                            value="{{ old('id_member', $user->id_member) }}">
                                        @error('id_member')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('major') is-invalid @enderror" id="major"
                                            ...
                                            <option value="D3 Teknologi Komputer"
                                                @if (old('major', $user->major) == 'D3 Teknologi Komputer') selected @endif>D3
                                                Teknologi Komputer</option>
                                            <option value="D3 Teknologi Informasi"
                                                @if (old('major', $user->major) == 'D3 Teknologi Informasi') selected @endif>D3
                                                Teknologi Informasi</option>
                                            <option value="D4 Teknologi Rekayasa Perangkat Lunak"
                                                @if (old('major', $user->major) == 'D4 Teknologi Rekayasa Perangkat Lunak') selected @endif>D4 Teknologi Rekayasa
                                                Perangkat Lunak</option>
                                            <option value="S1 Informatika"
                                                @if (old('major', $user->major) == 'S1 Informatika') selected @endif>S1
                                                Informatika</option>
                                            <option value="S1 Sistem Informasi"
                                                @if (old('major', $user->major) == 'S1 Sistem Informasi') selected @endif>S1
                                                Sistem Informasi</option>
                                            <option value="S1 Teknik Elektro"
                                                @if (old('major', $user->major) == 'S1 Teknik Elektro') selected @endif>S1
                                                Teknik Elektro</option>
                                            <option value="S1 Manajemen Rekayasa"
                                                @if (old('major', $user->major) == 'S1 Manajemen Rekayasa') selected @endif>S1
                                                Manajemen Rekayasa</option>
                                            <option value="S1 Teknik Metalurgi"
                                                @if (old('major', $user->major) == 'S1 Teknik Metalurgi') selected @endif>S1
                                                Teknik Metalurgi</option>
                                            <option value="S1 Teknik Bioproses"
                                                @if (old('major', $user->major) == 'S1 Teknik Bioproses') selected @endif>S1
                                                Teknik Bioproses</option>
                                            <option value="Umum/Lainnya" @if (old('major', $user->major) == 'Umum/Lainnya') selected @endif>
                                                Umum/Lainnya</option>
                                        </select>
                                        @error('major')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="inactive"
                                                {{ old('status', $user->status) == 'inactive' ? 'selected' : '' }}>Tidak
                                                Aktif</option>
                                        </select>
                                        @error('status')
                                            <div class="text-danger">{{ $message }}</div>
