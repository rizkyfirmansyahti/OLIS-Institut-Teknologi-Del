...
@section('title', 'CD/DVD')
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item active">CD/DVD</li>
    </ol>
@endsection
@section('content')
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            const table = $('#cd_datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: url,
                columns: [{
                ...
                showConfirmationDialog('Are you sure?', 'You won\'t be able to revert this!', 'warning',
                    'Yes, delete it!', (result) => {
                        if (result.isConfirmed) {
                            handleAction(url, 'DELETE', 'CD/DvD has been deleted!',
                                'Failed to delete CD/DVD!', {}, null, () => {
                                    table.ajax.reload();
                                });
                        }
                    });
