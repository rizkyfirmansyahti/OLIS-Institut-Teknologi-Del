...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('backend.books.update', encodeId($book->id)) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="language" id="language"
                                    ...
                                    <option value="Indonesia"
                                        {{ old('language', $book->language) == 'Indonesia' ? 'selected' : '' }}>
                                        Indonesia
                                    </option>
                                    <option value="Inggris"
                                        {{ old('language', $book->language) == 'Inggris' ? 'selected' : '' }}>
                                        Inggris
                                    </option>
                                </select>
                                @error('language')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('subject') is-invalid @enderror"
                                    id="subject" name="subject" value="{{ old('subject', $book->subject) }}">
                                @error('subject')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="cp_or" id="cp_or"
                                    ...
                                    <option value="CP" {{ old('cp_or', $book->cp_or) == 'CP' ? 'selected' : '' }}>
                                        CP
                                    </option>
                                    <option value="OR" {{ old('cp_or', $book->cp_or) == 'OR' ? 'selected' : '' }}>
                                        OR
                                    </option>
                                </select>
                            </div>
